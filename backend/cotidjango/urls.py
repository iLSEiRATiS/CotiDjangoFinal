...
urlpatterns += [
    ...
    re_path(r"^api/auth/forgot-password/?$", api_bridge.AuthForgotPasswordView.as_view(), name="api-bridge-forgot-password"),
    re_path(r"^api/auth/reset-password/?$", api_bridge.AuthResetPasswordView.as_view(), name="api-bridge-reset-password"),
    ...
    re_path(r"^api/store-config/?$", api_bridge.StoreConfigView.as_view(), name="api-bridge-store-config"),
    re_path(r"^api/categories-list/?$", api_bridge.CategoriesListView.as_view(), name="api-bridge-categories"),
    re_path(r"^api/supplier-contacts/?$", api_bridge.SupplierContactCreateView.as_view(), name="api-bridge-supplier-contacts"),
    ...
    re_path(r"^api/orders/(?P<pk>[^/]+)/pdf/?$", api_bridge.OrderPdfView.as_view(), name="api-bridge-order-pdf"),
    ...
    re_path(r"^api/admin/sales-calendar/?$", api_bridge.AdminSalesCalendarView.as_view(), name="api-bridge-admin-sales-calendar"),
    re_path(r"^api/admin/sales-calendar/(?P<date_str>\d{4}-\d{2}-\d{2})/?$", api_bridge.AdminDailySalesView.as_view(), name="api-bridge-admin-daily-sales"),
    re_path(r"^api/admin/sales-calendar/(?P<date_str>\d{4}-\d{2}-\d{2})/pdf/?$", api_bridge.AdminDailySalesPdfView.as_view(), name="api-bridge-admin-daily-sales-pdf"),
    ...
    re_path(r"^api/admin/orders/(?P<pk>[^/]+)/pdf/?$", api_bridge.AdminOrderPdfView.as_view(), name="api-bridge-admin-order-pdf"),
    re_path(r"^api/admin/orders/(?P<pk>[^/]+)/labels/?$", api_bridge.AdminOrderLabelsView.as_view(), name="api-bridge-admin-order-labels"),
